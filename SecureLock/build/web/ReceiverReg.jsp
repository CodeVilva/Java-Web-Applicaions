...
<html lang="en">
    ...
    <body>
        ...
        <div class="hero">
            ...
            <h1 class="display-4">Receiver Registration</h1>
            <p class="lead">Register as a receiver to be selected as a recipient for encrypted files.</p>
        </div>

        <div class="section">
            <div class="panel-narrow card">
                <h1 class="mb-4 text-center" style="font-size:1.6rem;">Registration</h1>
                <form action="ReceiverReg" method="post">
                    <div class="row g-3">
                        <div class="col-12">

...
<html lang="en">
    ...
    <body>
                ...
                <div class="nav-shell">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto">
                            ...
                            <a href="DataOwners.jsp" class="nav-item nav-link">Data Owners</a>
        ...
        <!-- Hero Start -->
        <div class="hero">
            <div class="hero-icon"><i class="fa fa-key"></i></div>
            <h1 class="display-4">Data Sender</h1>
            <p class="lead">Enter the one-time password sent to your email to continue.</p>
        </div>
        <!-- Hero End -->

        <div class="section">
            <div class="panel-narrow card">
                <h1 class="mb-4 text-center" style="font-size:1.6rem;">OTP Verification</h1>
                <form method="post" action="RVerifyotp">
                    <div class="row g-3">
                        <div class="col-12">
                            <input type="password" class="form-control" required="" name="otp" placeholder="Enter OTP"  style="height: 55px;">
                        </div>
                        <div class="col-12">
                            <button class="btn btn-primary w-100 py-3" type="submit">Verify</button>
                        </div>
                    </div>
                </form>
            </div>

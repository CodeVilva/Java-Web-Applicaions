...
<html lang="en">
    ...
    <body>
                ...
                <div class="nav-shell">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto">
                            ...
                            <a href="DataSender.jsp" class="nav-item nav-link">Data Sender</a>
                            <a href="DataReceivers.jsp" class="nav-item nav-link active">Data Receivers</a>
        ...
        <div class="hero">
            ...
            <h1 class="display-4">Data Receivers</h1>
            <p class="lead">Sign in to view files that have been securely shared with you.</p>
        </div>
        <!-- Hero End -->
        ...
        <div class="section">
            <div class="panel-narrow card">
                ...
                <form method="post" action="ReceiversLog">
                    <div class="row g-3">
                        <div class="col-12">
                ...
                <div class="pt-4 text-center">
                    <a href="ReceiverReg.jsp" style="color: var(--primary-dark); font-weight:600;">Click here for sign up</a>
                </div>
            </div>
        </div>
